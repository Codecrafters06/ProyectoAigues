...
const FormTriviaEcoMuseum: React.FC = () => {
    ...
    useEffect(() => {
        const fetchTrivia = async () => {
            try {
                const response = await axios.get('https://proyectoaigues-production.up.railway.app/trivia/3');
...
export default FormTriviaEcoMuseum