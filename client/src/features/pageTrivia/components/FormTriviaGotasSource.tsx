...
const FormTriviaGotasSource: React.FC = () => {
    ...
    useEffect(() => {
        const fetchTrivia = async () => {
            try {
                const response = await axios.get('https://proyectoaigues-production.up.railway.app/trivia/6');
...
export default FormTriviaGotasSource