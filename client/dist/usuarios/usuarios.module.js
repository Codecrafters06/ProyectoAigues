...
const trivia_schema_1 = require("../trivia/schemas/trivia.schema");
    ...
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: usuarios_schema_1.Usuarios.name, schema: usuarios_schema_1.UsuariosSchema },
            ]),
            mongoose_1.MongooseModule.forFeature([{ name: trivia_schema_1.Trivia.name, schema: trivia_schema_1.TriviaSchema }]),
        ],
